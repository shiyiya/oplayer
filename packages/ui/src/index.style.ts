...
export const ohui = (css: any, theme: SnowConfig['theme']) =>
  css({
...
export const ohloading = (css: any) =>
  css`
    position: absolute;
    left: 0;
    right: 0;
...
export const ohcontrollerwrap = (css: any) =>
  css({
...
export const ohcontroller = (css: any) =>
  css({
    position: 'absolute',
    left: '0',
    right: '0',
...
export const ohcontrollerprogress = (css: any) =>
  css({
    position: 'relative',
    height: '4px',
    width: '100%',
...
export const ohcontrollerbottom = (css: any) =>
  css({
    display: 'flex',
    'align-items': 'center',
...
export const ohcontrollertime = (css: any) =>
  css`
    display: flex;
    align-items: center;
    padding: 0px 0.5em;
...
export const speeditem = (css: any) =>
  css`
    font-size: 14px;
    display: block;
    padding: 6px 15px;
