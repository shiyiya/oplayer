import Player, { PlayerPluginV2, type PluginMeta, type MenuRegistry } from '@oplayer/core'
...
class AirPlay implements PlayerPluginV2 {
  public readonly meta: PluginMeta = { name: 'airplay' }
  ...
  setup(ctx: Parameters<PlayerPluginV2['setup']>[0]) {
    const player = ctx.player as unknown as Player
